...
import diorid.tiles.screenshot.App.setScreenshotPermission

class CheckScreenshotPermission : Activity() {
    companion object {
        ...
        private const val SCREENSHOT_REQUEST_CODE = 2222
        private const val WRITE_REQUEST_CODE = 12224
    }
